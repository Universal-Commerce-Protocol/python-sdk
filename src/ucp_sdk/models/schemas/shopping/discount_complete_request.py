...
from .cart_complete_request import CartCompleteRequest
from .checkout_complete_request import CheckoutCompleteRequest
from .types import amount_complete_request, reverse_domain_name_complete_request

DiscountExtensionCompleteRequest = TypeAliasType(
    "DiscountExtensionCompleteRequest",
    Annotated[Any, Field(..., title="Discount Extension Complete Request")],
)
"""
...
class Allocation(BaseModel):
    ...
    """
    amount: amount_complete_request.AmountCompleteRequest
    """
...
class Cart(CartCompleteRequest):
    """
...
class AppliedDiscount(BaseModel):
    ...
    """
    eligibility: (
        reverse_domain_name_complete_request.ReverseDomainNameCompleteRequest
        | None
    ) = None
    """
