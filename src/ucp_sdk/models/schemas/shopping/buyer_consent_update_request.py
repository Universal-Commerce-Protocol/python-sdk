...
from .types.buyer_update_request import BuyerUpdateRequest

BuyerConsentExtensionUpdateRequest = TypeAliasType(
    "BuyerConsentExtensionUpdateRequest",
    Annotated[Any, Field(..., title="Buyer Consent Extension Update Request")],
)
"""
...
class Buyer(BuyerUpdateRequest):
    """
