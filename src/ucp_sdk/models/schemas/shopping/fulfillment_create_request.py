...
from .types import (
    ...
    fulfillment_create_request,
    fulfillment_group_create_request,
    fulfillment_method_create_request,
    fulfillment_option_create_request,
)

FulfillmentExtensionCreateRequest = TypeAliasType(
    "FulfillmentExtensionCreateRequest",
    Annotated[Any, Field(..., title="Fulfillment Extension Create Request")],
)
"""
...
FulfillmentAvailableMethod = TypeAliasType(
    ...
    fulfillment_available_method_create_request.FulfillmentAvailableMethodCreateRequest,
)
...
FulfillmentOption = TypeAliasType(
    "FulfillmentOption",
    fulfillment_option_create_request.FulfillmentOptionCreateRequest,
)


FulfillmentGroup = TypeAliasType(
    "FulfillmentGroup",
    fulfillment_group_create_request.FulfillmentGroupCreateRequest,
)


FulfillmentMethod = TypeAliasType(
    "FulfillmentMethod",
    fulfillment_method_create_request.FulfillmentMethodCreateRequest,
)


Fulfillment = TypeAliasType(
    "Fulfillment", fulfillment_create_request.FulfillmentCreateRequest
)
