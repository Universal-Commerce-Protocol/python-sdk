...
from .types.buyer_create_request import BuyerCreateRequest

BuyerConsentExtensionCreateRequest = TypeAliasType(
    "BuyerConsentExtensionCreateRequest",
    Annotated[Any, Field(..., title="Buyer Consent Extension Create Request")],
)
"""
...
class Buyer(BuyerCreateRequest):
    """
