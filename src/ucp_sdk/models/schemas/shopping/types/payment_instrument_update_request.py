...
from ...common.types import postal_address_update_request
from . import payment_credential_update_request
...
class PaymentInstrumentUpdateRequest(BaseModel):
    ...
    """
    billing_address: (
        postal_address_update_request.PostalAddressUpdateRequest | None
    ) = None
    """
    The billing address associated with this payment method.
    """
    credential: (
        payment_credential_update_request.PaymentCredentialUpdateRequest | None
    ) = None
...
class SelectedPaymentInstrument(PaymentInstrumentUpdateRequest):
    """
