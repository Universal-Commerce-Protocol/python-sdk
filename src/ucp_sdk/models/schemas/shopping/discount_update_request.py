...
from .types import amount_update_request, reverse_domain_name_update_request

DiscountExtensionUpdateRequest = TypeAliasType(
    "DiscountExtensionUpdateRequest",
    Annotated[Any, Field(..., title="Discount Extension Update Request")],
)
"""
...
class Allocation(BaseModel):
    ...
    """
    amount: amount_update_request.AmountUpdateRequest
    """
...
class AppliedDiscount(BaseModel):
    ...
    """
    eligibility: (
        reverse_domain_name_update_request.ReverseDomainNameUpdateRequest | None
    ) = None
    """
