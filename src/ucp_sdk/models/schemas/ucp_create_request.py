...
from . import capability_create_request, payment_handler, service
...
class Requires(BaseModel):
    ...
    capabilities: (
        dict[
            reverse_domain_name_create_request.ReverseDomainNameCreateRequest,
            VersionConstraint,
        ]
        | None
    ) = None
...
class Base(BaseModel):
    ...
    capabilities: (
        dict[
            reverse_domain_name_create_request.ReverseDomainNameCreateRequest,
            list[capability_create_request.Base],
        ]
        | None
    ) = None
    """
...
class PlatformSchema(Base):
    ...
    capabilities: (
        dict[
            reverse_domain_name_create_request.ReverseDomainNameCreateRequest,
            list[capability_create_request.PlatformSchema],
        ]
        | None
    ) = None
    """
...
class BusinessSchema(Base):
    ...
    capabilities: (
        dict[
            reverse_domain_name_create_request.ReverseDomainNameCreateRequest,
            list[capability_create_request.BusinessSchema],
        ]
        | None
    ) = None
    """
...
class ResponseCheckoutSchema(Base):
    ...
    capabilities: (
        dict[
            reverse_domain_name_create_request.ReverseDomainNameCreateRequest,
            list[capability_create_request.ResponseSchema],
        ]
        | None
    ) = None
    """
...
UcpMetadataCreateRequest = TypeAliasType(
    "UcpMetadataCreateRequest",
    Annotated[
        PlatformSchema
        | BusinessSchema
